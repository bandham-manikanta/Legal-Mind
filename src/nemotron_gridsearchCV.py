...
# Function to process COMBINED_RETRIEVED_DOCS
def process_context_docs(combined_text):
    ...
    # If no documents after splitting, use the original text
...
if __name__ == "__main__":
    # Set your API key
    API_KEY = "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"  # Replace with your actual API key
    ...
    for idx, row in df.iterrows():
        ...
        context_docs = process_context_docs(row['COMBINED_RETRIEVED_DOCS'])
        print(f"Query: {query}")
        ...
        query_csv = f"{query_id}_hyperparameter.csv"
        query_heatmap = f"{query_id}_hyperparameter_heatmap.png"
    ...
    if all_results:
        # Combined results
        all_csv = "all_questions_hyperparameter.csv"
        ...
        plt.tight_layout()
        plt.savefig("average_hyperparameter_heatmap.png", dpi=300)
        plt.close()
        print("Average performance heatmap saved to average_hyperparameter_heatmap.png")
